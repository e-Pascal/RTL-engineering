...
- [Процесс разработки](#процесс-разработки)
  ...
  - [Описание работы с ROM](#описание-работы-с-rom)
...
Так же здесь реализован подсчет количества собранных монет, которые в процессе игры отображаются на светодиодах на плате в виде двоичного числа.
...
В данной реализации игры передвижение игрока осуществляется путем проверки координат по вертикали и горизонтали, в следствие чего возникает ситуация, когда игрок, двигаясь по диагонали попадает в угол запретной зоны, потому как за один шаг до этого ему было разрешено движение и по вертикали и по горизонтали. При возникновении такой ситауции в логике предусмотрен "откат" игрока влево вверх, что отлично работает при баге в 3-х из 4-х случаев. Эту фичу можно заметить, если попасть левым верхним углом хитбокса персонажа в правый нижний угол стены лабиринта.

![add mem](pic/bug.png)

В таком случае логика заставит сдвинуться персонажа влево вверх, пока он не достигнет разрешенной зоны.

<details>

  <summary>Код движения при попадании в запретную зону</summary>
